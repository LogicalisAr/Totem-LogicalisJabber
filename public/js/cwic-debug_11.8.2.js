	    ...
	    function onConversationCallStateChanged(content)
	    {
	        ...
	        switch(telephonyConversation.callState)
	        {
	            case 'OffHook':
					...
					$('#callStatus').html('Llamando');
					$('#callStatus').addClass('calling');
					$('#callStatus').removeClass('online')
	                break;
	            case 'Ringin':
					eventHandler = m_EventHandlers['onConversationIncoming'];
					$('#callStatus').html('Llamada entrante');
					$('#callStatus').addClass('calling');
					$('#callStatus').removeClass('online')
					$('#myModal').modal('show');
	                break;
	            ...
	            case 'Connected':
					...
					$('#callStatus').html('En Linea')
					$('#callStatus').removeClass('calling');
					$('#callStatus').addClass('online')
	                break;
	            default:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function TelephonyConversation(conversation)
	{
		...
		if(this.videoDirection =='inactive' || this.videoDirection != 'SendRecv'){
