...
(function(jabberwerx) {
    ...
    jabberwerx = jq.extend(jabberwerx, {
        ...
        _config: {
            ...
            capabilityFeatures: [],
            httpBindingURL: configData.presenceUrl,
...
(function(jabberwerx) {
    jabberwerx.ErrorReporter = jabberwerx.JWBase.extend({
        ...
        _errorMap: {
            ...
            "{urn:ietf:params:xml:ns:xmpp-sasl}not-authorized": "Invalid user name or password.",
...
(function(jabberwerx) {
    jabberwerx.ui = {
        ...
        getThemeURL: function() {
            return jabberwerx._getInstallURL() + this._config.themeName + '/';
        },
        _init: function() {
            this._inited = true;
            var config = {};
    ...
    jabberwerx.ui._init();
    var url = jabberwerx.ui.getThemeURL() + "styles.css";
...
(function(jabberwerx) {
    jabberwerx.ui.TextInput = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function(doc) {
            ...
            jabberwerx.$("<div/>").appendTo(builder).addClass("send_button").text("Send").click(this.invocation("_send"));
            jabberwerx.$("<textarea/>").appendTo(builder).addClass("chat_input").attr("rows", "3").bind("keypress", this.invocation("_handleKeyPress")).bind("keyup", this.invocation("_handleKeyUp"));
            return builder;
        },
        restoreDOM: function(doc) {
    ...
    jabberwerx.ui.ConsoleView = jabberwerx.ui.JWView.extend({
        ...
        _xmpp2html: function(node, parent) {
            ...
            switch (node.get(0).nodeType) {
                case 1: {
                    var htmlDOM = (node.contents().length ? this._templates["element"].clone() : this._templates["simple-element"].clone());
...
(function(jabberwerx) {
    jabberwerx.ui.TabbedView = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function(doc) {
            ...
            var content = jabberwerx.$("<div/>").appendTo(builder).addClass("tabcontent");
            var tablist = jabberwerx.$("<div/>").appendTo(builder).addClass("tablist");
            return builder.get(0);
        },
        restoreDOM: function(doc) {
    ...
    jabberwerx.ui.TabbedView.Tab = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function(doc) {
            var builder = jabberwerx.$("<div/>", doc).addClass("tab").bind("click", this.invocation("_handleTabClick")).attr("id", "jabberwerx_tabctrl_" + jabberwerx.util.slugify(this.id));
            ...
            jabberwerx.$("<img/>").appendTo(builder).attr("src", jabberwerx.ui.getThemeImageURL("icon-close.png")).attr("alt", "Close").attr("title", "Close").bind("click", this.invocation("_handleClose")).addClass("closer");
            return builder.get(0);
        },
        restoreDOM: function(doc) {
...
(function(jabberwerx) {
    ...
    jabberwerx.ui.RosterView.Grouping = jabberwerx.ui.JWView.extend({
        ...
        _updateHeader: function() {
            ...
            heading.find("span.extrainfo").text("" + totals.active + "/" + totals.total);
            switch (this.mode) {
...
(function(jabberwerx) {
    jabberwerx.ui.AuthenticationView = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function(doc) {
            var data = jabberwerx.$("<form/>", doc).addClass("jabberwerx auth_form").bind("submit", this.invocation("_login"));
            var userDiv = jabberwerx.$("<div/>").appendTo(data).addClass("username_div");
            jabberwerx.$("<label/>").appendTo(userDiv).attr("for", "username").text(jabberwerx._("Username:"));
            jabberwerx.$("<input type='text'/>").appendTo(userDiv).addClass("username");
            var passDiv = jabberwerx.$("<div/>").appendTo(data).addClass("password_div");
            jabberwerx.$("<label/>").appendTo(passDiv).attr("for", "password").text(jabberwerx._("Password:"));
            jabberwerx.$("<input type='password'/>").appendTo(passDiv).addClass("password");
            var submitDiv = jabberwerx.$("<div/>").appendTo(data).addClass("submit_div");
            jabberwerx.$("<label/>").appendTo(submitDiv).attr("for", "auth_submit");
            jabberwerx.$("<input type='submit'/>").appendTo(submitDiv).addClass("auth_submit").attr("value", jabberwerx._("Login"));
            var statusDiv = jabberwerx.$("<div/>").appendTo(data).attr("class", "auth_status_div").text("\u00A0");
...
(function(jabberwerx) {
    jabberwerx.ui.MucView = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function(doc) {
            ...
            jabberwerx.$("<div/>").appendTo(mucInterface).addClass("muc_title");
